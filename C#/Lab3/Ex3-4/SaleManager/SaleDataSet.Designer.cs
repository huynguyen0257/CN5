...
namespace SaleManager {
    ...
    public partial class SaleDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ItemsRow AddItemsRow(int ID, string ItemName, double UnitPrice, int Quantity) {
        ...
        public partial class ItemsRow : global::System.Data.DataRow {
            ...
            public double UnitPrice {
                get {
                    return ((double)(this[this.tableItems.UnitPriceColumn]));
                }
                set {
...
namespace SaleManager.SaleDataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([ID] = @Original_ID) AND ([ItemName] = @Origina" +
                "l_ItemName) AND ([UnitPrice] = @Original_UnitPrice) AND ([Quantity] = @Original_" +
                "Quantity))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([ID], [ItemName], [UnitPrice], [Quantity]) VALUES (@ID" +
                ", @ItemName, @UnitPrice, @Quantity);\r\nSELECT ID, ItemName, UnitPrice, Quantity F" +
                "ROM Items WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [ID] = @ID, [ItemName] = @ItemName, [UnitPrice] = @UnitPrice, [Quantity] = @Quantity WHERE (([ID] = @Original_ID) AND ([ItemName] = @Original_ItemName) AND ([UnitPrice] = @Original_UnitPrice) AND ([Quantity] = @Original_Quantity));
SELECT ID, ItemName, UnitPrice, Quantity FROM Items WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SaleManager.Properties.Settings.Default.SaleConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, ItemName, UnitPrice, Quantity FROM dbo.Items";
        ...
        public virtual int Fill(SaleDataSet.ItemsDataTable dataTable) {
        ...
        public virtual SaleDataSet.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SaleDataSet.ItemsDataTable dataTable = new SaleDataSet.ItemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SaleDataSet.ItemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_ItemName, double Original_UnitPrice, int Original_Quantity) {
        ...
        public virtual int Insert(int ID, string ItemName, double UnitPrice, int Quantity) {
        ...
        public virtual int Update(int ID, string ItemName, double UnitPrice, int Quantity, int Original_ID, string Original_ItemName, double Original_UnitPrice, int Original_Quantity) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((double)(Original_UnitPrice));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ItemName, double UnitPrice, int Quantity, int Original_ID, string Original_ItemName, double Original_UnitPrice, int Original_Quantity) {
            return this.Update(Original_ID, ItemName, UnitPrice, Quantity, Original_ID, Original_ItemName, Original_UnitPrice, Original_Quantity);
        }
    }
